...
public interface FileCustomRepository {
    List<FileQuerySearchResponseDTO> queryAllFile ();
    Page<FileQuerySearchResponseDTO> queryFilesByPage(FileQueryRequestDTO fileQueryRequestDTO, Pageable pageable);
